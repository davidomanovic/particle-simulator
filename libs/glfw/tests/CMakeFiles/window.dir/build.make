...
tests/CMakeFiles/window.dir/window.c.obj: tests/CMakeFiles/window.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=C:\GitHub\Verlet-Particles\libs\glfw\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/CMakeFiles/window.dir/window.c.obj"
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -MD -MT tests/CMakeFiles/window.dir/window.c.obj -MF CMakeFiles\window.dir\window.c.obj.d -o CMakeFiles\window.dir\window.c.obj -c C:\GitHub\Verlet-Particles\libs\glfw\tests\window.c
...
tests/CMakeFiles/window.dir/window.c.i: cmake_force
	...
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E C:\GitHub\Verlet-Particles\libs\glfw\tests\window.c > CMakeFiles\window.dir\window.c.i
...
tests/CMakeFiles/window.dir/window.c.s: cmake_force
	...
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S C:\GitHub\Verlet-Particles\libs\glfw\tests\window.c -o CMakeFiles\window.dir\window.c.s
...
tests/window.exe: tests/CMakeFiles/window.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=C:\GitHub\Verlet-Particles\libs\glfw\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable window.exe"
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\window.dir\link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/window.dir/clean:
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\tests && $(CMAKE_COMMAND) -P CMakeFiles\window.dir\cmake_clean.cmake
.PHONY : tests/CMakeFiles/window.dir/clean

tests/CMakeFiles/window.dir/depend:
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\GitHub\Verlet-Particles\libs\glfw C:\GitHub\Verlet-Particles\libs\glfw\tests C:\GitHub\Verlet-Particles\libs\glfw C:\GitHub\Verlet-Particles\libs\glfw\tests C:\GitHub\Verlet-Particles\libs\glfw\tests\CMakeFiles\window.dir\DependInfo.cmake "--color=$(COLOR)"

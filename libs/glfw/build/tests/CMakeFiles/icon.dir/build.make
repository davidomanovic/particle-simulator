...
tests/CMakeFiles/icon.dir/icon.c.obj: C:/GitHub/Verlet-Particles/libs/glfw/tests/icon.c
tests/CMakeFiles/icon.dir/icon.c.obj: tests/CMakeFiles/icon.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=C:\GitHub\Verlet-Particles\libs\glfw\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/CMakeFiles/icon.dir/icon.c.obj"
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\build\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -MD -MT tests/CMakeFiles/icon.dir/icon.c.obj -MF CMakeFiles\icon.dir\icon.c.obj.d -o CMakeFiles\icon.dir\icon.c.obj -c C:\GitHub\Verlet-Particles\libs\glfw\tests\icon.c
...
tests/CMakeFiles/icon.dir/icon.c.i: cmake_force
	...
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\build\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E C:\GitHub\Verlet-Particles\libs\glfw\tests\icon.c > CMakeFiles\icon.dir\icon.c.i
...
tests/CMakeFiles/icon.dir/icon.c.s: cmake_force
	...
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\build\tests && C:\mingw64\bin\clang.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S C:\GitHub\Verlet-Particles\libs\glfw\tests\icon.c -o CMakeFiles\icon.dir\icon.c.s
...
tests/icon.exe: tests/CMakeFiles/icon.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=C:\GitHub\Verlet-Particles\libs\glfw\build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable icon.exe"
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\build\tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\icon.dir\link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/icon.dir/clean:
	cd /d C:\GitHub\Verlet-Particles\libs\glfw\build\tests && $(CMAKE_COMMAND) -P CMakeFiles\icon.dir\cmake_clean.cmake
